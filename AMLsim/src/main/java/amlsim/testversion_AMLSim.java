...
public class AMLSim extends SimState {
	...
	private static TransactionRepository txs;
	private static TransactionRepository txs_withoutSAR;
	...
	public void executeSimulation() {
		...
		long step;
		while ((step = super.schedule.getSteps()) < 10) {  //numOfSteps
	...
	public static void main(String[] args) {
		...
		if (!runEvaluation){
			sim.txs = new TransactionRepository(TX_SIZE);
		}else{
			sim.txs_withoutSAR = new TransactionRepository(TX_SIZE_withoutSAR);
		
		}
		System.out.println("Random no"+rand.nextDouble());
