...
def main():
    ...
    parser.add_argument('--clients', nargs='+', help='Types of clients to train.', default=['LogRegClient']) # LogRegClient, DecisionTreeClient, RandomForestClient, GradientBoostingClient, SVMClient, KNNClient, MLPClient, GraphSAGEClient
    ...
    parser.add_argument('--train_nodes_files', nargs='+', help='Paths to train nodes data.', default=[
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/a_nodes_train.csv',
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/b_nodes_train.csv',
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/c_nodes_train.csv'
    ])
    parser.add_argument('--train_edges_files', nargs='+', help='Paths to train edges data.', default=[
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/a_edges_train.csv',
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/b_edges_train.csv',
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/c_edges_train.csv'
    ])
    ...
    parser.add_argument('--test_nodes_files', nargs='+', help='Paths to test nodes files', default=[
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/a_nodes_test.csv',
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/b_nodes_test.csv',
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/c_nodes_test.csv'
    ])
    parser.add_argument('--test_edges_files', nargs='+', help='Paths to test edges files', default=[
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/a_edges_test.csv',
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/b_edges_test.csv',
        f'/home/edvin/Desktop/flib/experiments/data/{DATASET}/preprocessed/c_edges_test.csv'
    ])
