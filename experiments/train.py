...
def main():
    ...
    parser.add_argument('--client_config_files', nargs='+', help='Paths to client config files.', default=[
        f'experiments/experiments/{EXPERIMENT}/clients/c0/config.yaml',
        f'experiments/experiments/{EXPERIMENT}/clients/c1/config.yaml',
        f'experiments/experiments/{EXPERIMENT}/clients/c2/config.yaml'
    ])
    ...
    parser.add_argument('--clients', nargs='+', help='Client types to train.', default=['DecisionTreeClient']) # LogRegClient, DecisionTreeClient, RandomForestClient, GradientBoostingClient, SVMClient, KNNClient, MLPClient, GraphSAGE
