...
class DecisionTreeClient():
    ...
    def run(self, **kwargs):
        self.train()
        train_roc_auc, train_tpfptnfn = self.evaluate(dataset='trainset')
        val_roc_auc, val_tpfptnfn = self.evaluate(dataset='valset')
        test_roc_auc, test_tpfptnfn = self.evaluate(dataset='testset')
        results = {0: {'train': {'loss': train_roc_auc, 'tpfptnfn': train_tpfptnfn}, 'val': {'loss': val_roc_auc, 'tpfptnfn': val_tpfptnfn}, 'test': {'loss': test_roc_auc, 'tpfptnfn': test_tpfptnfn}}}
        return results
