...
class Datacheck():
    ...
    # init
    def __init__(self, dataset:str, importance, aggregated = True,attention_weights=False):
        self.dataset = dataset
        self.load_data(dataset)
        self.attention_weights = attention_weights
        self.importance_test = self.build_importance( importance=importance)
    ...
    def load_data(self,dataset):
        ...
        self.normal_train=pd.read_csv(f'ultra_final_data/{DATASET}/bank/train/nodes.csv')
        self.normal_test=pd.read_csv(f'ultra_final_data/{DATASET}/bank/test/nodes.csv')
        # self.normal_val=pd.read_csv(f'final_data/{DATASET}/bank/val/nodes.csv')
        self.withoutSAR_train=pd.read_csv(f'ultra_final_data/{DATASET}_withoutSAR/bank/train/nodes.csv')
        self.withoutSAR_test=pd.read_csv(f'ultra_final_data/{DATASET}_withoutSAR/bank/test/nodes.csv')
    ...
    def aggregate_by_attention(self, data):
    ...
    def build_importance(self, importance='std', aggregated=True):
        ...
        #     importance_test['account']=accounts_test
            ...
            importance_test=importance_test.drop(['bank','is_sar','sum'],axis=1)
