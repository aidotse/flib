...
def node_index_mapping(nodes,edges):
    ...
    org_to_new_mapping = {old_idx.item(): new_idx for old_idx, new_idx in node_index_mapping}

    # Create a dictionary mapping new indices to original indices
    new_to_org_mapping = {new_idx: old_idx.item() for old_idx, new_idx in node_index_mapping}
