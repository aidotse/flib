...
if __name__ == "__main__":
    ...
    parser.add_argument('--clients_dir', type=str, help='Path to directory for client. Optional, if provided will devide the raw data over the clients.', default=f'experiments/{EXPERIMENT}/clients')
